...
class Patient extends Person {
  ...
  static Future<void> registre_patient(
    ...
    var url = Uri.parse("http://192.168.1.5:8080/signup_patient")
        // .replace(host: "192.168.1.5")
        ;
  ...
  static getUrgance() async {
    List<Urgance> list = [];
    var url = Uri.parse('http://192.168.1.5:8080/API/get_urgance');
  ...
  static get_sous_urgance(String id) async {
    ...
    var url = Uri.parse("http://192.168.1.5:8080/API/get_sous_urgance/${id}");
  ...
  static get_reponse(String id) async {
    List<Reponse> list = [];
    var url = Uri.parse("http://192.168.1.5:8080/API/get_reponse/${id}");
  ...
  static Future<Map<String, dynamic>> login_patient(
    ...
    var url = Uri.parse("http://192.168.1.5:8080/login_patient")
        // .replace(host: "192.168.1.5")
        ;
  ...
  static getProfil(String? id) async {
    var url = Uri.parse("http://192.168.1.5:8080/API/get-Profil/${id}");
    var response = await http.get(url);
    var data = jsonDecode(response.body);
  ...
  static demandDoctor(Demand domand) async {
    var url = Uri.parse("http://192.168.1.5:8080/API/demandDoctor");
